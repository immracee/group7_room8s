...
<html lang="en">
<head>
<title>Roommates App - Change First Name</title>
<meta charset="utf-8" />
...
<body>
  ...
  <section class="signup-form" id="accountsignup">
  	...
  	<form action="process-changefirstname.php" method="post">
      ...
      <div class="form-group">
              <input type="text" id="signupFirstName" class="form-control" name="signupFirstName">
          </div>
